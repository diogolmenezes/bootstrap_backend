...
class Authorization {
    ...
    createJWT(data, expire = true) {
        ...
        let options = expire ? { expiresIn: this.config.authorization.jwt.expiresIn } : {};
    ...
    protect(req, res, next) {
        ...
        let isEnabled = this.config.authorization && this.config.authorization.enabled;
    ...
    baererValidate(req, res, next) {
        ...
        this.jwt.verify(req.authorization.credentials, this.config.authorization.jwt.secret, (err, decoded) => {
